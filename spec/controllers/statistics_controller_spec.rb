...
describe StatisticsController do
  ...
  let(:valid_attributes) { { "var1" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved statistic as @statistic" do
        ...
        post :create, {:statistic => { "var1" => "invalid value" }}, valid_session
        assigns(:statistic).should be_a_new(Statistic)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested statistic" do
        ...
        Statistic.any_instance.should_receive(:update).with({ "var1" => "MyString" })
        put :update, {:id => statistic.to_param, :statistic => { "var1" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the statistic as @statistic" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Statistic.any_instance.stub(:save).and_return(false)
        put :update, {:id => statistic.to_param, :statistic => { "var1" => "invalid value" }}, valid_session
        assigns(:statistic).should eq(statistic)
      end
