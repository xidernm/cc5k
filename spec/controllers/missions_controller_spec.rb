  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved mission as @mission" do
        ...
        post :create, {:mission => { "name" => "invalid value" }}, valid_session
        assigns(:mission).should be_a_new(Mission)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mission" do
        ...
        Mission.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => mission.to_param, :mission => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the mission as @mission" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mission.any_instance.stub(:save).and_return(false)
        put :update, {:id => mission.to_param, :mission => { "name" => "invalid value" }}, valid_session
        assigns(:mission).should eq(mission)
      end
